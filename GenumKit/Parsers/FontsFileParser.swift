...
extension CTFont {
  static func parseFontInfo(_ fileURL: URL) -> [Font] {
    let descs = CTFontManagerCreateFontDescriptorsFromURL(fileURL as CFURL) as NSArray?
...
public final class FontsFileParser {
  ...
  public func parseFonts(_ path: String) {
