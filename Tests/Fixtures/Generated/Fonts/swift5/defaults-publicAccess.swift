...
public enum FontFamily {
  ...
  public enum MaterialDesignIcons {
    public static let regular = FontConvertible(name: "MaterialDesignIcons-Regular", family: "MaterialDesignIcons", path: "MaterialDesignIcons.ttf")
  ...
  public static let allCustomFonts: [FontConvertible] = [SFNSDisplay.all, SFNSText.all, Avenir.all, MaterialDesignIcons.all, ZapfDingbats.all, Public.all].flatMap { $0 }
