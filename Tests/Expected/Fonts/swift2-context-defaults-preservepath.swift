...
internal enum FontFamily {
  internal enum SFNSDisplay {
    internal static let Black = FontConvertible(".SFNSDisplay-Black", family: ".SF NS Display", path: "Fonts/SFNSDisplay-Black.otf")
  ...
  internal enum Avenir {
    ...
    internal static let BlackOblique = FontConvertible("Avenir-BlackOblique", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let Book = FontConvertible("Avenir-Book", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let BookOblique = FontConvertible("Avenir-BookOblique", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let Heavy = FontConvertible("Avenir-Heavy", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let HeavyOblique = FontConvertible("Avenir-HeavyOblique", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let Light = FontConvertible("Avenir-Light", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let LightOblique = FontConvertible("Avenir-LightOblique", family: "Avenir", path: "Fonts/Avenir.ttc")
    internal static let Medium = FontConvertible("Avenir-Medium", family: "Avenir", path: "Fonts/Avenir.ttc")
