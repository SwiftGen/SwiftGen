...
enum StoryboardScene {
  ...
  enum Dependency: StoryboardType {
    ...
    static let dependent = SceneType<ValidatePasswordViewController>(storyboard: Dependency.self, identifier: "Dependent")
  }
  ...
  enum Message: StoryboardType {
    ...
    static let urlChooser = SceneType<PickerViewController>(storyboard: Message.self, identifier: "URLChooser")
  }
  ...
  enum Wizard: StoryboardType {
    ...
    static let validatePassword = SceneType<ValidatePasswordViewController>(storyboard: Wizard.self, identifier: "Validate_Password")
  }
}
