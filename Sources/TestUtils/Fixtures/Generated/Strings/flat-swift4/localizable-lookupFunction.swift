...
enum L10n {
  ...
  static var alertMessage: String { return L10n.tr("Localizable", "alert__message") }
  /// Title of the alert
  static var alertTitle: String { return L10n.tr("Localizable", "alert__title") }
  /// These are %3$@'s %1$d %2$@.
  ...
  /// This is a %% character.
  static var percent: String { return L10n.tr("Localizable", "percent") }
  ...
  static var settingsNavigationBarSelf: String { return L10n.tr("Localizable", "settings.navigation-bar.self") }
  /// DeepSettings
  static var settingsNavigationBarTitleDeeperThanWeCanHandleNoReallyThisIsDeep: String { return L10n.tr("Localizable", "settings.navigation-bar.title.deeper.than.we.can.handle.no.really.this.is.deep") }
  /// Settings
  static var settingsNavigationBarTitleEvenDeeper: String { return L10n.tr("Localizable", "settings.navigation-bar.title.even.deeper") }
  /// Here you can change some user profile settings.
  static var settingsUserProfileSectionFooterText: String { return L10n.tr("Localizable", "settings.user__profile_section.footer_text") }
  /// User Profile Settings
  static var settingsUserProfileSectionHEADERTITLE: String { return L10n.tr("Localizable", "settings.user__profile_section.HEADER_TITLE") }
}
