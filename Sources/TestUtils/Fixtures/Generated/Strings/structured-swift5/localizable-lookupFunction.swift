...
internal enum L10n {
  ...
  /// value1
  internal static var key1: String { return L10n.tr("Localizable", "key1") }
  /// These are %3$@'s %1$d %2$@.
  ...
  internal enum Key1 {
    ...
    internal static var anonymous: String { return L10n.tr("Localizable", "key1.anonymous") }
  }
  ...
  internal enum What {
    internal enum Happens {
      /// some comment
      internal static var here: String { return L10n.tr("Localizable", "what./*happens*/.here") }
    }
  }
}
