...
enum L10n {
  ...
  enum Settings {
    enum NavigationBar {
      ...
      static var `self`: String { return L10n.tr("Localizable", "settings.navigation-bar.self") }
      enum Title {
        enum Deeper {
          enum Than {
            enum We {
                  ...
                  enum No {
                    enum Really {
                      enum This {
                        enum Is {
                          /// DeepSettings
                          static var deep: String { return L10n.tr("Localizable", "settings.navigation-bar.title.deeper.than.we.can.handle.no.really.this.is.deep") }
                        }
                      }
                    }
                  }
        ...
        enum Even {
          /// Settings
          static var deeper: String { return L10n.tr("Localizable", "settings.navigation-bar.title.even.deeper") }
        }
      }
    }
    enum UserProfileSection {
      /// Here you can change some user profile settings.
      static var footerText: String { return L10n.tr("Localizable", "settings.user__profile_section.footer_text") }
      /// User Profile Settings
      static var headerTitle: String { return L10n.tr("Localizable", "settings.user__profile_section.HEADER_TITLE") }
    }
  }
}
