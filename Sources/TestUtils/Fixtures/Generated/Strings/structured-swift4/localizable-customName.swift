...
enum XCTLoc {
  ...
  enum Settings {
    ...
    enum UserProfileSection {
      ...
      static let footerText = XCTLoc.tr("Localizable", "settings.user__profile_section.footer_text")
      /// User Profile Settings
      static let headerTitle = XCTLoc.tr("Localizable", "settings.user__profile_section.HEADER_TITLE")
    }
  }
}
