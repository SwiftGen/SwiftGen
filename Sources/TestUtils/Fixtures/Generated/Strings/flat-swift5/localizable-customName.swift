...
enum XCTLoc {
  ...
  static let alertMessage = XCTLoc.tr("Localizable", "alert__message")
  /// Title of the alert
  static let alertTitle = XCTLoc.tr("Localizable", "alert__title")
  /// These are %3$@'s %1$d %2$@.
  ...
  /// This is a %% character.
  static let percent = XCTLoc.tr("Localizable", "percent")
  ...
  static let settingsUserProfileSectionFooterText = XCTLoc.tr("Localizable", "settings.user__profile_section.footer_text")
  /// User Profile Settings
  static let settingsUserProfileSectionHEADERTITLE = XCTLoc.tr("Localizable", "settings.user__profile_section.HEADER_TITLE")
}
