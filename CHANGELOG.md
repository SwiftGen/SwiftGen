...
* Reordered the code generated by templates for `xcassets`, so that all the generated constants are grouped at the end of the generated file (instead of in the middle in between static code). This makes it easier to find the list of constants/assets when opening the files.  
  [Olivier Halligon](https://github.com/AliSoftware)
