...
<table border="0"><tr>
  <td>
    ...
    <ul>
      ...
      <li><a href="#infoplist">Info.plist</a>
...
```sh
swiftgen plist -t swift3 /path/to/Info.plist
```
...
<details>
<summary>Example of **code generated by the `swift3` template**</summary>
```
...
class _InfoPlist {
  subscript(key: InfoPlistKey) -> Any? {
    return _Plist["\(key)"]
  }
}
