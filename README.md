...
* [`enums` for your Assets Catalogs images](#uiimage-nsimage)
* [`enums` for your `Localizable.strings` strings](#localizablestrings).
* [`enums` for your `UIStoryboard` and their Scenes](#uistoryboard)
* [`enums` for your `UIColor`s and `NSColor`s](#uicolor-nscolor).
* [`enums` for your `UIFont`s and `NSFont`s](#uifont-nsfont).
