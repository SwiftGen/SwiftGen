...
This [script](https://gist.github.com/Lutzifer/3e7d967f73e38b57d4355f23274f303d) can be run inside the project to transform NSLocalizedString(...) calls to the tr(...) syntax.
