...
| `options` | Dictionary | Any optional list of settings for the parser, to change it's behaviour. See the commands' specific documentation for available options. |
