...
| `localizeFunction` | `NSLocalizedString` | Allows you to set your own custom localization function. Your custom function must have the same signature as the one provided by `Foundation`, i.e. `NSLocalizedString(_:tableName:bundle:comment:)` |
