...
Be sure to consult [the templates repo's own Migration Guide](https://github.com/SwiftGen/templates/blob/master/Documentation/MigrationGuide.md#templates-20-migration-guide) to see the list of changes (renamings or removal) in templates bundled in SwiftGen.
...
The code generated by the `storyboards` templates is **not** compatible with your current codebase. Please read the [templates migration guide](https://github.com/SwiftGen/templates/blob/master/Documentation/MigrationGuide.md#functionality-changes-in-20-swiftgen-50) for more information, which includes a compatibility template. Essentially, you need to change calls like the following line:
